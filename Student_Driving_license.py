...
def update():
    Dlid=8976578905
    label_id["text"]=str(Dlid)
    print(type(Dlid))
    
    nofD="Shawn Mendes"
    label_name["text"]=str(nofD)
    print(type(nofD))
    
    Ddob="December 25th 4099"
    label_dob["text"]=str(Ddob)
    print(type(Ddob))
    
    Dpin=450997
    label_pin["text"]=str(Dpin)
    print(type(Dpin))
    
    Da="Texas fat"
    label_address["text"]=str(Da)
    print(type(Da))
    
    Dvt=["2,4"]
    label_vehicle_type["text"]=str(Dvt)
    print(type(Dvt))
    

    
    
button1=Button(root, command=update, text="Show Drivers License")
